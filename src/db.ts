...
export function insertRecord(btcData: BTC): boolean {
    try {
        ...
        stmt.run(
            ...
            btcData.time,
            btcData.latest_url,
            btcData.previous_hash,
            btcData.previous_url,
            btcData.peer_count,
            btcData.unconfirmed_count,
            btcData.high_fee_per_kb,
            btcData.medium_fee_per_kb,
            btcData.low_fee_per_kb,
            btcData.last_fork_height,
            btcData.last_fork_hash
        );
  } catch (error) {
...
export function countRecord(): number {
    try {
